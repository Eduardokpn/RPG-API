...
namespace RpgAPI.Controllers
{
    [ApiController]
    [Route("[Controller]")]
    public class PersonagemExerciciosController : ControllerBase
    {
        private static List<Personagem> personagens = new List<Personagem>()
        {
            //Colar os objetos da lista do chat aqui
            new Personagem() { Id = 1, Nome = "Frodo", PontosVida=100, Forca=17, Defesa=23, Inteligencia=33, Classe=ClasseEnum.Cavaleiro},
            new Personagem() { Id = 2, Nome = "Sam", PontosVida=122, Forca=15, Defesa=25, Inteligencia=30, Classe=ClasseEnum.Cavaleiro},
            new Personagem() { Id = 3, Nome = "Galadriel", PontosVida=170, Forca=18, Defesa=21, Inteligencia=35, Classe=ClasseEnum.Clerigo },
        ...
        {
            if(newPersonagem.Classe == ClasseEnum.Mago && newPersonagem.Inteligencia <35)
            {
               return BadRequest("Não é Adicionr o personagem");
            }
        ...
        {
            return Ok( "Quant Personagens: " + personagens.Count + "Soma de pontos de Inteligencia: " + personagens.Sum(p => p.Inteligencia));
        ...
        {
            List<Personagem> listaBusca = personagens.FindAll(p => p.Id == id);
